...
function Tab({ href, label, active, render }: TabProps) {
...
function NavContent() {
  ...
  // Sichtbarkeit: runter => zeigen, rauf => verstecken; ganz oben => zeigen
  const show = useScrollShowOnDown({ threshold: 6, topAlwaysShow: 12 });

  // Höhe: Icon + vertikaler Puffer + Safe-Area
        ...
        <Tab
          ...
          render={(color) => (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                 fill="currentColor" style={{ color, width: '100%', height: '100%' }} aria-hidden="true">
              {/* Haus mit transparenter Tür (Maske) */}
              <mask id="homeDoorMask">
                <rect width="24" height="24" fill="white" />
                <rect x="10.2" y="16.2" width="3.6" height="6" rx="1.1" fill="black" />
              </mask>
          ...
          render={(color) => (
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
              ...
              <path
                fillRule="evenodd"
                clipRule="evenodd"
                d="M10.5 3a7.5 7.5 0 0 1 5.917 12.136l4.473 4.474a1.5 1.5 0 1 1-2.122 2.121l-4.473-4.473A7.5 7.5 0 1 1 10.5 3Zm0 3a4.5 4.5 0 1 0 0 9 4.5 4.5 0 0 0 0-9Z"
              />
