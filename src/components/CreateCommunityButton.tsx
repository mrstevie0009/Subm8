      ...
      <div className="min-h-full flex items-center justify-center py-4 sm:py-10 px-3">
        ...
        >
          ...
          <form
            ...
            style={{ maxHeight: 'calc(100vh - 2rem)' }} // mobile: Karte nie höher als Viewport - 2rem
          >
            {/* Header */}
            <div className="shrink-0 px-4 sm:px-5 py-3 border-b border-white/10 flex items-center justify-between">
              <div className="text-base sm:text-lg font-semibold">Create community</div>
              <button
                type="button"
            ...
            <div className="flex-1 overflow-y-auto px-4 sm:px-5 py-4 space-y-4">
              <label className="block space-y-1.5">
                ...
                <input
                  ...
                  placeholder="KinkyGroupFun"
                  required
                />
              </label>

              <label className="block space-y-1.5">
                <span className="text-sm opacity-80">Handle (optional)</span>
                <input
                  className={inputCls}
                  value={handle}
                  onChange={(e: React.ChangeEvent<HTMLInputElement>) => setHandle(e.target.value)}
                  placeholder="e.g. eu-fetish-scene"
                />
                <div className="text-xs opacity-60">So erscheint es: <code>@{handle || 'your-handle'}</code></div>
              </label>
              ...
              <label className="block space-y-1.5">
                <span className="text-sm opacity-80">Join policy</span>
                <select
                  className={inputCls}
                  value={policy}
                ...
                >
                  ...
                  <option value="DOMME_ONLY">Domme only</option>
              ...
              <div className="space-y-2">
                <div className="text-sm opacity-80">Banner (optional)</div>
                <div
                ...
                >
                  <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                    ...
                    <div className="text-sm opacity-70">
                      PNG/JPG/WebP/GIF, max ~10MB. Drag & drop supported.
                    </div>
                  </div>
